...
/* ---------- Quotes ---------- */
const QUOTE_SELECT =
  "*, quote_lines(*), packing_list_items(*), client:clients(id,company,email), lead:leads(id,company,contact,email,phone,address,vat_no), supplier:suppliers(id,company), agent:agents(id,company), transporter:transporters(id,company), clearing_agent:clearing_agents(id,company)";
